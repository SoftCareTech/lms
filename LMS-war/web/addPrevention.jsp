  ...
  <body>
    ...
    <div class="blog-header">
      <div class="container">
        ...
        <p class="lead blog-description">Add Prevention . </p>
      </div>
    </div>
                  ...
                  <form name="form" method="post">
                      ...
                      <table > 
                          ...
                          <label class="col-sm-4">DISEASE NAME</label>
                           ...
                           <textarea name="name" type="text" cols="40" rows="5" class="form-control"> </textarea>
                          
                      </div>  </td> 
                             <td>       
                      <div >
                          <p>
                          <label class="col-sm-4">DISEASE PREVENTION </label>
                         </p>
                         <textarea name="pre" type="text" cols="40" rows="5" class="form-control"></textarea> 
