...
return false;
    ...
    List<Housing> alist =sl.viewHousing(ida);
    int g=0;
    if(alist!=null)
    for(Housing h:alist){
        g++;
...
if (alist.size() == 0) {
                                        %>
                                <div> No Housing Found <a href="addhousing.jsp>?id=<%=ida%>">add Housing </a></div>
                                    <%} else {
                                    %>
                                        <tbody>
                                            <tr>
...
count++;
                                                ...
                                                <td><%=count%></td>
                                                <td>
                                                    <textarea cols="50" rows="10" value="<%=app.getMethod() %>" 
                                                              name="<%="e"+Integer.toString(count)%>"    ><%=app.getMethod()%></textarea>     </td>
