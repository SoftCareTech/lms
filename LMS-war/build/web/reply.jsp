...
if(request.getParameter("sumit")!= null && request.getParameter("sumit")!=" "){
   try{
     ...
     Updates u =new Updates(sl.generateUpdateID(),a.getIda(),
            LocalDate.now().toString()+"|"+ LocalTime.now().toString(),a.getCom()+" is recently answered ");
     //sl.addUpdate(u);
       }
      // msg= " fill in name ";
   }catch(Exception e){
              ...
              <div >
                  <form name="form" method="post">
                      ...
                      <table > 
                          ...
                          <p>
                              <label class="col-sm-4"><h3>Reply </h3> </label>
                      </p>
                      <textarea name="reply" type="text" cols="50" rows="10" class="form-control"></textarea> 
